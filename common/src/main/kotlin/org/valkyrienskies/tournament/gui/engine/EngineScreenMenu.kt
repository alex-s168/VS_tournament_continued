package org.valkyrienskies.Tournament.gui.engine
...
import org.valkyrienskies.Tournament.util.inventorySlots

class EngineScreenMenu(syncId: Int, playerInv: Inventory, val blockEntity: EngineBlockEntity?) :
    AbstractContainerMenu(TournamentScreens.ENGINE.get(), syncId) {
